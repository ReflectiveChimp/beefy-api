...
const APOLLO_TIMEOUT = process.env.APOLLO_TIMEOUT ? Number.parseInt(process.env.APOLLO_TIMEOUT) : 30_000;
...
export function theGraphClient(subgraphId: string, baseUrl = 'https://gateway.thegraph.com/api') {
...
export const cakeClient = client(envString('PCS_GRAPHQL_KEY', 'PCS_GRAPHQL_KEY'));
