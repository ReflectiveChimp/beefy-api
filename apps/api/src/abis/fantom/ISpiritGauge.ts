const ISpiritGauge = [
  {
    inputs: [
      { internalType: 'address', name: '_spirit', type: 'address' },
      { internalType: 'address', name: '_inSpirit', type: 'address' },
      { internalType: 'address', name: '_token', type: 'address' },
      { internalType: 'address', name: '_gaugeProxy', type: 'address' },
    ],
