const rswETH = [
  ...
  { inputs: [], name: 'BotMethodsPaused', type: 'error' },
  { inputs: [], name: 'CannotBeZeroAddress', type: 'error' },
  { inputs: [], name: 'CannotReferSelf', type: 'error' },
  { inputs: [], name: 'CannotRepriceWithZeroRswETHSupply', type: 'error' },
  ...
  { inputs: [], name: 'NoActiveValidators', type: 'error' },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'repricerswETHDiff', type: 'uint256' },
      {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_rswETHTotalSupply', type: 'uint256' },
    ],
    name: 'reprice',
    outputs: [],
    stateMutability: 'nonpayable',
