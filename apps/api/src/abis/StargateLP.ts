const StargateLPAbi = [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_sharedDecimals', type: 'uint256' },
      { internalType: 'uint256', name: '_localDecimals', type: 'uint256' },
      { internalType: 'address', name: '_feeLibrary', type: 'address' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'bool', name: 'batched', type: 'bool' },
      {
        indexed: false,
        internalType: 'uint256',
        name: 'swapDeltaBP',
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_amountLP', type: 'uint256' }],
    name: 'amountLPtoLD',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'bool', name: '_fullMode', type: 'bool' }],
    name: 'callDelta',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_mintFeeBP', type: 'uint256' }],
    name: 'setFee',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'bool', name: '_swapStop', type: 'bool' }],
    name: 'setSwapStop',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
