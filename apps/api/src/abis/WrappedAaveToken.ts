const WrappedAaveTokenAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: 'forceUpdate', type: 'bool' },
    ],
    name: 'claimRewards',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'bool', name: 'forceUpdate', type: 'bool' }],
  ...
  {
    inputs: [],
    name: 'getLifetimeRewardsClaimed',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'string', name: 'staticATokenName', type: 'string' },
      { internalType: 'string', name: 'staticATokenSymbol', type: 'string' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'dynamicAmount', type: 'uint256' },
...
export default WrappedAaveTokenAbi;
