const SiloLens = [
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'totalUserDeposits', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: '_totalBorrowAmount', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: '_totalDeposits', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
] as const;
export default SiloLens;
