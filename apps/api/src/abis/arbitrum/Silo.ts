const Silo = [
  ...
  { inputs: [], name: 'DepositNotPossible', type: 'error' },
  { inputs: [], name: 'DepositsExceedLimit', type: 'error' },
  { inputs: [], name: 'DifferentArrayLength', type: 'error' },
  { inputs: [], name: 'InvalidRepository', type: 'error' },
  { inputs: [], name: 'InvalidSiloVersion', type: 'error' },
  { inputs: [], name: 'LiquidationReentrancyCall', type: 'error' },
  { inputs: [], name: 'MaximumLTVReached', type: 'error' },
  ...
  { inputs: [], name: 'UnexpectedEmptyReturn', type: 'error' },
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_asset', type: 'address' },
      { internalType: 'uint256', name: '_amount', type: 'uint256' },
      { internalType: 'bool', name: '_collateralOnly', type: 'bool' },
    ],
    name: 'deposit',
    outputs: [
      { internalType: 'uint256', name: 'collateralAmount', type: 'uint256' },
      { internalType: 'uint256', name: 'collateralShare', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes', name: '_flashReceiverData', type: 'bytes' },
    ],
    name: 'flashLiquidate',
    outputs: [
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'repaidShare', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    inputs: [],
    name: 'siloRepository',
    outputs: [{ internalType: 'contract ISiloRepository', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'withdrawnShare', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
