const NettChef = [
  {
    ...
    inputs: [
      { type: 'address', name: '_nett', internalType: 'contract NETT' },
      { type: 'address', name: '_devAddr', internalType: 'address' },
      { type: 'uint256', name: '_nettPerSec', internalType: 'uint256' },
  ...
  },
  {
    type: 'function',
    stateMutability: 'view',
    outputs: [{ type: 'address', name: '', internalType: 'contract NETT' }],
    name: 'nett',
    inputs: [],
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { type: 'address', name: 'bonusTokenAddress', internalType: 'address' },
      { type: 'string', name: 'bonusTokenSymbol', internalType: 'string' },
      { type: 'uint256', name: 'pendingBonusToken', internalType: 'uint256' },
    ],
    name: 'pendingTokens',
    inputs: [
      { type: 'uint256', name: '_pid', internalType: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { type: 'uint256', name: 'accNETTPerShare', internalType: 'uint256' },
      { type: 'uint256', name: 'lpSupply', internalType: 'uint256' },
  ...
  },
  {
    ...
    outputs: [],
    name: 'setDevPercent',
    inputs: [{ type: 'uint256', name: '_newDevPercent', internalType: 'uint256' }],
  },
  {
    type: 'function',
    stateMutability: 'view',
  ...
  },
  {
    ...
    outputs: [],
    name: 'updateEmissionRate',
    inputs: [{ type: 'uint256', name: '_nettPerSec', internalType: 'uint256' }],
  },
  {
    type: 'function',
    stateMutability: 'nonpayable',
