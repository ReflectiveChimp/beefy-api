const AuraBooster = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_voteOwnership', type: 'address' },
      { internalType: 'address', name: '_voteParameter', type: 'address' },
    ],
  ...
  },
  {
    ...
    name: 'feeTokens',
    outputs: [
      { internalType: 'address', name: 'distro', type: 'address' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes32', name: '_space', type: 'bytes32' },
    ],
    name: 'setDelegate',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_feeDistro', type: 'address' },
    ],
    name: 'setFeeInfo',
    outputs: [],
    stateMutability: 'nonpayable',
