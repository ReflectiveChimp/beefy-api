const StrategyABI = [
  {
    ...
    inputs: [
      { type: 'address', name: '_want', internalType: 'address' },
      { type: 'address', name: '_rewardPool', internalType: 'address' },
      { type: 'address', name: '_secondOutput', internalType: 'address' },
  ...
  },
  {
    ...
    stateMutability: 'view',
    outputs: [{ type: 'address', name: '', internalType: 'address' }],
    name: 'secondOutputToOutputRoute',
    inputs: [{ type: 'uint256', name: '', internalType: 'uint256' }],
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    outputs: [],
    name: 'setKeeper',
    inputs: [{ type: 'address', name: '_keeper', internalType: 'address' }],
  },
  {
    type: 'function',
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [],
    name: 'setUnirouter',
    inputs: [{ type: 'address', name: '_unirouter', internalType: 'address' }],
  },
  {
    type: 'function',
    stateMutability: 'nonpayable',
