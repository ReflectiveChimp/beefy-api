const SwapAbi = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'newAdminFee', type: 'uint256' }],
    name: 'setAdminFee',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'newFlashLoanFeeBPS', type: 'uint256' },
      {
        internalType: 'uint256',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'contract LPToken', name: 'lpToken', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
