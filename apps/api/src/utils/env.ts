/**
 * Undefined, or empty string returns defaultValue
 * Otherwise returns value
 */
export function envString(key: string, defaultValue: string): string;
export function envString(key: string, defaultValue?: undefined): string | undefined;
export function envString(key: string, defaultValue?: string | undefined): string | undefined {
