...
export type PassThroughHeadersInit = string[][] | Record<string, string | ReadonlyArray<string>> | Headers;
...
export type PassThroughURLSearchParamsInit = URLSearchParams | string | ReadonlyArray<[string, string]>;
