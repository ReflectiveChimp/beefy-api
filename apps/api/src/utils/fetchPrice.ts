import { ChainId, type Token, addressBookByChainId } from 'blockchain-addressbook';
import { getAddress } from 'viem';
import { getAmmLpPrice, getAmmPrice, getAmmTokenPrice } from '../api/stats/getAmmPrices.js';
...
export function validOracleOrAny(oracle: string | undefined | null): PriceOracle {
  if (oracle === 'lps' || oracle === 'tokens') {
    return oracle;
  }
  return 'any';
}
