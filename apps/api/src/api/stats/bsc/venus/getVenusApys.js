...
import { default as IUnitroller } from '../../../../abis/IUnitroller.jsx';
import { default as VToken } from '../../../../abis/VToken.jsx';
import { BSC_CHAIN_ID } from '../../../../constants.js';
import pools from '../../../../data/bsc/venusPools.json';
...
const getBorrowApys = async (pool) => {
  ...
  const [venusPrice, bnbPrice, borrowRate, venusRate, totalBorrows] = await Promise.all([
    fetchPrice({ oracle: 'tokens', id: 'XVS' }),
    fetchPrice({ oracle: pool.oracle, id: pool.oracleId }),
