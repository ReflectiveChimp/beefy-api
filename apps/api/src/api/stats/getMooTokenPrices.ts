...
import { BIG_ZERO, isFiniteBigNumber } from '../../utils/big-number.js';
...
import { getMultichainVaults } from './getMultichainVaults.js';
import type { ApiChain } from '../../utils/chain.js';

let mooTokenPrices: Partial<Record<ApiChain, Record<string, number>>> = {};
...
export const initMooTokenPriceService = async () => {
  const cachedMooTokenPrices = await getKey('MOO_TOKEN_PRICES');
