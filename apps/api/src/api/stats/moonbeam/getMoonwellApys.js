...
import MoonwellComptroller from '../../../abis/moonbeam/MoonwellComptroller.jsx';
import ImToken from '../../../abis/moonbeam/mToken.js';
import { BASE_HPY, MOONBEAM_CHAIN_ID, MOONBEAM_CHAIN_ID as chainId } from '../../../constants.js';
...
import pools from '../../../data/moonbeam/moonwellPools.json';
...
const getSupplyApys = async (
  ...
  const [wellPrice, glmrPrice, tokenPrice] = await Promise.all([
...
export default getMoonwellApys;
