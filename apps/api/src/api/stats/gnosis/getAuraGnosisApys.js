import { balancerGnosisClient as client } from '../../../apollo/client.js';
import { GNOSIS_CHAIN_ID as chainId } from '../../../constants.js';
import { getAuraApys } from '../common/balancer/getAuraApys.js';

import balPools from '../../../data/gnosis/auraPools.json';
import balancerV3Pools from '../../../data/gnosis/balancerV3Pools.json';

const pools = [...balPools, ...balancerV3Pools];
...
export default getAuraGnosisApys;
