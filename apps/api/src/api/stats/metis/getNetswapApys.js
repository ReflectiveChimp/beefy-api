...
import SimpleRewarderPerSec from '../../../abis/avax/SimpleRewarderPerSec.jsx';
import NettChef from '../../../abis/metis/NettChef.jsx';
import { NET_LPF } from '../../../constants.js';
...
import { BASE_HPY, METIS_CHAIN_ID } from '../../../constants.js';
import pools from '../../../data/metis/netswapLpPools.json';
...
const getPoolsData = async (pools) => {
  ...
  const tokenPerSecCalls = rewarders.map((rewarder) => {
    ...
    const rewarderContract = fetchContract(rewarder, SimpleRewarderPerSec, METIS_CHAIN_ID);
