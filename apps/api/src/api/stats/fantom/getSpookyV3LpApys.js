...
import SpookyChefV2 from '../../../abis/fantom/SpookyChefV2.jsx';
import SpookyComplexRewarder from '../../../abis/fantom/SpookyComplexRewarder.jsx';
import { BASE_HPY, FANTOM_CHAIN_ID } from '../../../constants.js';
import { SPOOKY_LPF } from '../../../constants.js';
import pools from '../../../data/fantom/spookyV3LpPools.json';
import { fetchPrice } from '../../../utils/fetchPrice.js';
import { getFarmWithTradingFeesApy } from '../../../utils/getFarmWithTradingFeesApy.js';
...
const getPoolsData = async (pools) => {
  ...
  for (let i = 0; i < pools.length; i++) {
    const rewarderContract = fetchContract(rewarders[i], SpookyComplexRewarder, FANTOM_CHAIN_ID);
    rewardPerSecCalls.push(rewarderContract.read.rewardPerSecond().catch((_) => Number.NaN));
    ...
    rewarderTotalAllocPointCalls.push(rewarderContract.read.totalAllocPoint().catch((_) => Number.NaN));
  }
...
export default getSpookyV3LpApys;
