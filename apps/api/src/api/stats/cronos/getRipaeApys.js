...
import RipaeRewardPool from '../../../abis/cronos/RipaeRewardPool.jsx';
import { vvsClient } from '../../../apollo/client.js';
import { BASE_HPY, CRONOS_CHAIN_ID } from '../../../constants.js';
import pools from '../../../data/cronos/ripaeLpPools.json';
...
const getRipaeApys = async () => {
  ...
  const [{ rewardPerSecond, totalAllocPoint }, { balances, allocPoints }, tradingAprs] = await Promise.all([
    getMasterChefData(),
    getPoolsData(pools),
