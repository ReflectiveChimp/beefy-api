...
import IAuraMinter from '../../../../abis/IAuraMinter.js';
import { default as IAuraGauge } from '../../../../abis/ethereum/AuraGauge.js';
...
const getPoolApy = async (
  ...
  const rewardsApy: BigNumber = yearlyRewardsInUsd.dividedBy(totalStakedInUsd);
