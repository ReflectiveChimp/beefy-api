...
import { type ApyBreakdownResult, getApyBreakdownOnly as getApyBreakdownNew } from './getApyBreakdownNew.js';
...
export const getApyBreakdown = (
  ...
  composablePoolAprs?: (number|undefined)[] | undefined,
  clmAprs?: number[] | undefined,
  merklAprs?: (number | undefined)[] | undefined,
): ApyBreakdownResult => {
