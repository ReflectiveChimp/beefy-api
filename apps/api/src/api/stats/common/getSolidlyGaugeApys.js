...
import ISolidlyGauge from '../../../abis/ISolidlyGauge.jsx';
import IVe from '../../../abis/IVe.jsx';
import InfraredGauge from '../../../abis/InfraredGauge.jsx';
import RamsesGauge from '../../../abis/RamsesGauge.jsx';
import ISpiritGauge from '../../../abis/fantom/ISpiritGauge.jsx';
import IinSpirit from '../../../abis/fantom/IinSpirit.jsx';
...
export const getFarmApys = async (params) => {
  ...
  const nftCalls = [];
  const rewardTokenPrice = await fetchPrice({
