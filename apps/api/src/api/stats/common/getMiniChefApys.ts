...
import { isSushiClient, isSushiTridentClient } from '../../../apollo/client.js';
// trading apr
import { SUSHI_LPF } from '../../../constants.js';
import {
  getTradingFeeApr,
...
// abis
import SushiComplexRewarderTime from '../../../abis/matic/SushiComplexRewarderTime.js';
...
const getPoolsData = async (params: MiniChefApyParams) => {
  ...
  const rewarderContract = rewarderConfig
