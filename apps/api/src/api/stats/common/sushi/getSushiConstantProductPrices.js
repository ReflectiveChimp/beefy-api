...
import ISushiConstantProductLP from '../../../../abis/ISushiConstantProductLP.jsx';
...
const getPoolData = async (chainId, pool, tokenPrices) => {
  ...
  const [reserveCall, totalSupplyCall] = [lpContract.read.getNativeReserves(), lpContract.read.totalSupply()];
...
export default getSushiConstantProductPrices;
