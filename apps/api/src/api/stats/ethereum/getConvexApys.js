...
import curveLendPools from '../../../data/ethereum/curveLendPools.json';
...
const lpPools = convexPools.filter((p) => p.rewardPool);
const lendPools = curveLendPools.filter((p) => p.rewardPool);
