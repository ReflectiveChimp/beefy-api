...
import AuraBooster from '../../../abis/ethereum/AuraBooster.jsx';
import AuraGauge from '../../../abis/ethereum/AuraGauge.jsx';
import AuraToken from '../../../abis/ethereum/AuraToken.jsx';
import { ETH_CHAIN_ID, ETH_CHAIN_ID as chainId } from '../../../constants.js';
...
import balV3Pools from '../../../data/ethereum/balancerV3pools.json';
...
const getAuraData = async () => {
  ...
  const premint = new BigNumber('5e25');
