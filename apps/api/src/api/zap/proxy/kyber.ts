...
import { getKyberApi } from '../api/kyber/index.js';
import type { QuoteData, QuoteRequest, SwapData, SwapRequest } from '../api/kyber/types.js';
...
const getProxiedQuote = async (request: QuoteRequest, chain: AnyChain): Promise<ApiResponse<QuoteData>> => {
  try {
