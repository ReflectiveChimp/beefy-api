import { moonbeam } from 'blockchain-addressbook/moonbeam';
import { groupBy, mapKeys } from 'lodash';
import { type Address, getAddress } from 'viem';
import { bigintRange, isDefined } from '../../../../utils/array.js';
import { type AppChain, toChainId } from '../../../../utils/chain.js';
import { getUnixNow, isUnixBetween } from '../../../../utils/date.js';
import { getJson } from '../../../../utils/http/index.js';
import { isFiniteNumber, toNumber } from '../../../../utils/number.js';
import { fetchContract } from '../../../rpc/client.js';
import { ProviderApiError, UnsupportedChainError, isProviderApiError } from '../../errors.js';
import type { IOffchainRewardProvider, RewardToken, StellaSwapCampaign, Vault } from '../../types.js';
import { rewardRegistryAbi, rewarderAbi } from './abi.js';
import type { FarmingAprResponse, FarmingAprResult, RewardInfo, RewarderEntry } from './types.js';
