...
import { type AnyChain, isApiChain, toAppChain } from '../../utils/chain.js';
import { createFactory } from '../../utils/factory.js';
import { sendBadRequest, sendServiceUnavailable, sendSuccess } from '../../utils/koa.js';
import { typedEntries } from '../../utils/object.js';
import { getAllCowClmsByChain } from '../cowcentrated/getCowClms.js';
import { isCowClmWithRewardPool, isCowClmWithVault } from '../cowcentrated/types.js';
import { getVaultsByType } from '../stats/getMultichainVaults.js';
import { OffchainRewards } from './OffchainRewards.js';
import type { Campaign, CampaignsWithMeta, ProviderId, Vault } from './types.js';
...
export const handleOffChainRewardsAll = makeRequestHandler({
  chain: false,
  active: false,
});
export const handleOffChainRewardsAllForChain = makeRequestHandler({
  chain: true,
  active: false,
});

export const handleOffChainRewardsActive = makeRequestHandler({
  chain: false,
  active: true,
});
